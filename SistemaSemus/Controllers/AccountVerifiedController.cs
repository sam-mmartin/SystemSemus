...
{
    public class AccountVerifiedController : Controller
    {
        #region Var & Constructor
        private ApplicationSignInManager _signInManager;
        private ApplicationUserManager _userManager;

        public AccountVerifiedController()
        {
        }

        public AccountVerifiedController(ApplicationUserManager userManager, ApplicationSignInManager signInManager)
        {
